...
- `indices:monitor/stats` on `shipit-*` indices - Required for index existence check in History
...
```json
{
  ...
  "index_permissions": [{
    ...
    "allowed_actions": ["crud", "create_index", "delete_index", "indices:monitor/stats"]
  }]
}
```
